        ...
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if is_void((x, y + 1, z), (wx, wy + 1, wz), world_voxels):
                    ...
                    # make sure there is a consistent orientation of the faces
...
# gets the ambient occlusion values to shade voxel based on positions and number of voxels next to it
@njit
def get_ao(local_pos, world_pos, world_voxels, plane):
    ...
    # get ambient occlusion based on all four sides of this plane's faces
